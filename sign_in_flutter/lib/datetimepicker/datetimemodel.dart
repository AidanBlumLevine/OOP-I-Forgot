...
class CommonPickerModel extends BasePickerModel {
  ...
  String extraStringAtIndex(int index) {
    return null;
  }
  ...
  void setExtraIndex(int index) {
    _currentExtraIndex = index;
  }
...
class CustomDateTimePickerModel extends CommonPickerModel {
  DateTime maxTime;
  DateTime minTime;
  CustomDateTimePickerModel({DateTime currentTime, DateTime maxTime, DateTime minTime, LocaleType locale}) : super(locale: locale) {
    if (currentTime != null) {
      this.currentTime = currentTime;
    ...
    _currentExtraIndex = this.currentTime.hour < 12 ? 0 : 1;
  ...
  DateTime finalTime() {
    DateTime time = currentTime.add(Duration(days: _currentLeftIndex));
    int hour = _currentMiddleIndex + 12 * _currentExtraIndex;
...
class CustomTimePickerModel extends CommonPickerModel {
  ...
  DateTime finalTime() {
    ...
    return currentTime.isUtc ? DateTime.utc(0, 0, 0, hour, minute) : DateTime(0, 0, 0, hour, minute);
  }
